          ...
          <table class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left">
                <div class="input-group">
                <select name="record_layout[0][layout_id]" class="form-control store_layouts">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
            ...
            <tbody>
              <tr>
                ...
                <td class="left">
                <div class="input-group">
                <select name="record_layout[<?php echo $store['store_id']; ?>][layout_id]" class="form-control store_layouts">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
