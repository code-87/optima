...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-placement="bottom" data-toggle="tooltip" title="<?php echo $title_callback;?>" href="<?php echo isset($callback) ? $callback : '' ;?>"><span class="label label-danger pull-left"><?php echo isset($countcallback) ? $countcallback: '0'; ?></span> <i class="fa fa-phone-square fa-lg"></i></a><!--add-->
