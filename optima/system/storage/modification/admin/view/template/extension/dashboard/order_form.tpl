      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-dashboard" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="dashboard_order_width" id="input-width" class="form-control">
                ...
                <?php if ($column == $dashboard_order_width) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="dashboard_order_sort_order" value="<?php echo $dashboard_order_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>
