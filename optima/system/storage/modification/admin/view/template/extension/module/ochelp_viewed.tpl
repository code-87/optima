            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab-setting">
                ...
                <div class="form-group">
                  ...
                  for="input-title"><?php echo $entry_title; ?></label>
                  <div class="col-sm-10">
                    <?php foreach ($languages as $language) { ?>
                    <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" class="form-control" name="title[<?php echo $language['language_id']; ?>]" value="<?php echo $title ? $title[$language['language_id']] : ''; ?>" />
                  </div>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"
                for="input-link-text"><?php echo $entry_link_text; ?></label>
                <div class="col-sm-10">
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <input type="text" class="form-control" name="link_text[<?php echo $language['language_id']; ?>]" value="<?php echo $link_text ? $link_text[$language['language_id']] : ''; ?>" />
                </div>
                <?php } ?>
              </div>
            </div>
