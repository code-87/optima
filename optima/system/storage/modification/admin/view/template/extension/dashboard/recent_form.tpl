  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-dashboard_recent" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-dashboard" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="dashboard_recent_width" id="input-width" class="form-control">
                ...
                <?php if ($column == $dashboard_recent_width) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="dashboard_recent_status" id="input-status" class="form-control">
                <?php if ($dashboard_recent_status) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="dashboard_recent_sort_order" value="<?php echo $dashboard_recent_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>
