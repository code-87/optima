...
class ModelCatalogProduct extends Model {
	...
	public function deleteProduct($product_id) {
		...
		//
		$this->db->query("DELETE FROM " . DB_PREFIX . "acc WHERE id = '" . (int)$product_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "shiny WHERE id = '" . (int)$product_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "diski WHERE id = '" . (int)$product_id . "'");
