	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) 
		{
			...
			if( !empty($this->request->post['stay']) )
			{
				...
				$this->response->redirect($this->url->link('extension/module/socnetauth2', 'token=' . $this->session->data['token'].'&tab='.$tab.'&tab2='.$tab2, 'SSL'));
				/* end 1505 */	
			}
			else
			{
		...
		foreach($this->data['languages'] as $i=>$lang)
		{
			...
			$default_hash['default_instagram_title'][ $lang['language_id'] ] = $Lang->get('default_instagram_title');
		...
		elseif( $this->config->has('socnetauth2_shop_folder_in_redirect') )
		{ 
			$this->data['socnetauth2_shop_folder_in_redirect'] = $this->config->get('socnetauth2_shop_folder_in_redirect');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_shop_folder_in_url') )
		{ 
			$this->data['socnetauth2_shop_folder_in_url'] = $this->config->get('socnetauth2_shop_folder_in_url');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_shop_folder_in_img') )
		{ 
			$this->data['socnetauth2_shop_folder_in_img'] = $this->config->get('socnetauth2_shop_folder_in_img');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_shop_folders') )
		{ 
			$this->data['socnetauth2_shop_folders'] =  $this->custom_unserialize( 
				$this->config->get('socnetauth2_shop_folders')
			);
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_is_noiframe') )
		{ 
			$this->data['socnetauth2_is_noiframe'] = $this->config->get('socnetauth2_is_noiframe');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_bline_html') )
		{ 
			$this->data['socnetauth2_bline_html'] = $this->custom_unserialize( $this->config->get('socnetauth2_bline_html') );
		}
		...
		elseif( $this->config->has('socnetauth2_lline_html') )
		{ 
			$this->data['socnetauth2_lline_html'] = $this->custom_unserialize( $this->config->get('socnetauth2_lline_html') );
		}
		...
		elseif( $this->config->has('socnetauth2_kvadrat_html') )
		{ 
			$this->data['socnetauth2_kvadrat_html'] = $this->custom_unserialize( $this->config->get('socnetauth2_kvadrat_html') );
		}
		...
		elseif( $this->config->has('socnetauth2_design_general_css') )
		{ 
			$this->data['socnetauth2_design_general_css'] = $this->config->get('socnetauth2_design_general_css');
		}
		else
		{
			$this->data['socnetauth2_design_general_css'] = '.sna_bline_table td { padding-right: 10px; }  /* ячейка иконок в линии крупных значков */'."\n".
			...
			'.sna_bline_ul { padding-left: 0px; }'.
			'.sna_bline_ul li { padding-right: 10px; padding-bottom: 10px; float: left; list-style: none; } '.
			'.sna_lline_ul { padding-left: 0px; }'.
			'.sna_lline_ul li { padding-right: 10px; padding-bottom: 10px; float: left; list-style: none; } '
			;
		}
		...
		elseif( $this->config->has('socnetauth2_mobile_control') )
		{ 
		...
		elseif( $this->config->has('socnetauth2_design_account_status') )
		{ 
			$this->data['socnetauth2_design_account_status'] = $this->config->get('socnetauth2_design_account_status');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_checkout_status') )
		{ 
			$this->data['socnetauth2_design_checkout_status'] = $this->config->get('socnetauth2_design_checkout_status');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_reg_status') )
		{ 
			$this->data['socnetauth2_design_reg_status'] = $this->config->get('socnetauth2_design_reg_status');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_account_html') )
		{ 
			$this->data['socnetauth2_design_account_html'] = $this->config->get('socnetauth2_design_account_html');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_account_css') )
		{ 
			$this->data['socnetauth2_design_account_css'] = $this->config->get('socnetauth2_design_account_css');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_account_header') )
		{ 
			$this->data['socnetauth2_design_account_header'] = $this->custom_unserialize( $this->config->get('socnetauth2_design_account_header') );
		}
		else
		{
			$this->data['socnetauth2_design_account_header'] = $default_hash['default_header_name'];
		}
		...
		elseif( $this->config->has('socnetauth2_design_widget_status') )
		{ 
			$this->data['socnetauth2_design_widget_status'] = $this->custom_unserialize( $this->config->get('socnetauth2_design_widget_status') );
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_checkout_html') )
		{ 
			$this->data['socnetauth2_design_checkout_html'] = $this->config->get('socnetauth2_design_checkout_html');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_checkout_css') )
		{ 
			$this->data['socnetauth2_design_checkout_css'] = $this->config->get('socnetauth2_design_checkout_css');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_checkout_header') )
		{ 
			$this->data['socnetauth2_design_checkout_header'] = $this->custom_unserialize( $this->config->get('socnetauth2_design_checkout_header') );
		}
		else
		{
			$this->data['socnetauth2_design_checkout_header'] = $default_hash['default_header_name'];
		}
		...
		elseif( $this->config->has('socnetauth2_design_reg_html') )
		{ 
			$this->data['socnetauth2_design_reg_html'] = $this->config->get('socnetauth2_design_reg_html');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_reg_css') )
		{ 
			$this->data['socnetauth2_design_reg_css'] = $this->config->get('socnetauth2_design_reg_css');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_design_reg_header') )
		{ 
			$this->data['socnetauth2_design_reg_header'] = $this->custom_unserialize( $this->config->get('socnetauth2_design_reg_header') );
		}
		else
		{
			$this->data['socnetauth2_design_reg_header'] = $default_hash['default_header_name'];
		}
		...
		elseif( $this->config->has('socnetauth2_vkontakte_agent') )
		{ 
			$this->data['socnetauth2_vkontakte_agent'] = $this->config->get('socnetauth2_vkontakte_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_gmail_agent') )
		{ 
			$this->data['socnetauth2_gmail_agent'] = $this->config->get('socnetauth2_gmail_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_odnoklassniki_agent') )
		{ 
			$this->data['socnetauth2_odnoklassniki_agent'] = $this->config->get('socnetauth2_odnoklassniki_agent');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_facebook_agent') )
		{ 
			$this->data['socnetauth2_facebook_agent'] = $this->config->get('socnetauth2_facebook_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_twitter_agent') )
		{ 
			$this->data['socnetauth2_twitter_agent'] = $this->config->get('socnetauth2_twitter_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_mailru_agent') )
		{ 
			$this->data['socnetauth2_mailru_agent'] = $this->config->get('socnetauth2_mailru_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_yandex_agent') )
		{ 
			$this->data['socnetauth2_yandex_agent'] = $this->config->get('socnetauth2_yandex_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_steam_agent') )
		{ 
			$this->data['socnetauth2_steam_agent'] = $this->config->get('socnetauth2_steam_agent');
		}
		else
		{
			if( $this->config->has('socnetauth2_status') )
		...
		elseif( $this->config->has('socnetauth2_twitter_title') )
			$this->data['socnetauth2_twitter_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_twitter_title') );
		else
		...
		elseif( $this->config->has('socnetauth2_facebook_title') )
			$this->data['socnetauth2_facebook_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_facebook_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_vkontakte_title') )
			$this->data['socnetauth2_vkontakte_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_vkontakte_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_odnoklassniki_title') )
			$this->data['socnetauth2_odnoklassniki_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_odnoklassniki_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_gmail_title') )
			$this->data['socnetauth2_gmail_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_gmail_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_mailru_title') )
			$this->data['socnetauth2_mailru_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_mailru_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_yandex_title') )
			$this->data['socnetauth2_yandex_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_yandex_title'));
		else
		...
		elseif( $this->config->has('socnetauth2_steam_title') )
			$this->data['socnetauth2_steam_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_steam_title') );
		else
			$this->data['socnetauth2_steam_title'] = $default_hash['default_steam_title'];
		
		if (isset($this->request->post['socnetauth2_instagram_title'])) 
			$this->data['socnetauth2_instagram_title'] = $this->request->post['socnetauth2_instagram_title'];
		elseif( $this->config->has('socnetauth2_instagram_title') )
			$this->data['socnetauth2_instagram_title'] = $this->custom_unserialize( $this->config->get('socnetauth2_instagram_title') );
		else
			$this->data['socnetauth2_instagram_title'] = $default_hash['default_instagram_title'];
		...
		{ 
			$this->data['socnetauth2_steam_debug'] = $this->config->get('socnetauth2_steam_debug');
		}
		...
		elseif( $this->config->has('socnetauth2_steam_status') )
		{ 
			$this->data['socnetauth2_steam_status'] = $this->config->get('socnetauth2_steam_status');
		}
		else
		{
		...
		{ 
			$this->data['socnetauth2_steam_api_key'] = $this->config->get('socnetauth2_steam_api_key');
		}
		...
		} elseif ($this->config->get('socnetauth2_steam_customer_group_id')) { 
			$this->data['socnetauth2_steam_customer_group_id'] = $this->config->get('socnetauth2_steam_customer_group_id');
		} else {
		...
		{ 
			$this->data['socnetauth2_yandex_debug'] = $this->config->get('socnetauth2_yandex_debug');
		}
		...
		elseif( $this->config->has('socnetauth2_yandex_status') )
		{ 
			$this->data['socnetauth2_yandex_status'] = $this->config->get('socnetauth2_yandex_status');
		}
		else
		{
		...
		{ 
			$this->data['socnetauth2_yandex_client_id'] = $this->config->get('socnetauth2_yandex_client_id');
		}
		...
		{ 
			$this->data['socnetauth2_yandex_client_secret'] = $this->config->get('socnetauth2_yandex_client_secret');
		}
		...
		} elseif ($this->config->get('socnetauth2_yandex_customer_group_id')) { 
			$this->data['socnetauth2_yandex_customer_group_id'] = $this->config->get('socnetauth2_yandex_customer_group_id');
		} else {
		...
		} elseif ($this->config->get('socnetauth2_yandex_rights_email')) { 
			$this->data['socnetauth2_yandex_rights_email'] = $this->config->get('socnetauth2_yandex_rights_email');
		} else {
		...
		} elseif ($this->config->get('socnetauth2_yandex_rights_info')) { 
			$this->data['socnetauth2_yandex_rights_info'] = $this->config->get('socnetauth2_yandex_rights_info');
		} else {
		...
		elseif( $this->config->has('socnetauth2_show_source_in_order') )
		{ 
			$this->data['socnetauth2_show_source_in_order'] = $this->config->get('socnetauth2_show_source_in_order');
		}
		else
		{
		...
		elseif( $this->config->has('socnetauth2_show_source_in_customer') )
		{ 
			$this->data['socnetauth2_show_source_in_customer'] = $this->config->get('socnetauth2_show_source_in_customer');
		}
		else
		{
		...
		elseif(  $this->config->has('socnetauth2_telephone_mask') )
		{ 
			$this->data['socnetauth2_telephone_mask'] = $this->config->get('socnetauth2_telephone_mask');
		}
		else
		{
		...
		elseif(  $this->config->has('socnetauth2_is_close_disabled') )
		{ 
			$this->data['socnetauth2_is_close_disabled'] = $this->config->get('socnetauth2_is_close_disabled');
		}
		else
		{
		...
		$this->data['entry_instagram_status'] = $this->language->get('entry_instagram_status');
		$this->data['entry_instagram_agent'] = $this->language->get('entry_instagram_agent');
		$this->data['entry_instagram_agent_loginza'] = $this->language->get('entry_instagram_agent_loginza');
		$this->data['entry_instagram_agent_notice'] = $this->language->get('entry_instagram_agent_notice');
		$this->data['entry_instagram_customer_group_id'] = $this->language->get('entry_instagram_customer_group_id');
		$this->data['entry_instagram_client_id'] = $this->language->get('entry_instagram_client_id');
		$this->data['entry_instagram_client_secret'] = $this->language->get('entry_instagram_client_secret');
		$this->data['entry_instagram_agent_extension'] = $this->language->get('entry_instagram_agent_extension');
		
		if (isset($this->request->post['socnetauth2_instagram_client_id'])) 
			$this->data['socnetauth2_instagram_client_id'] = $this->request->post['socnetauth2_instagram_client_id'];
		else
			$this->data['socnetauth2_instagram_client_id'] = $this->config->get('socnetauth2_instagram_client_id');
		
		if (isset($this->request->post['socnetauth2_instagram_client_secret'])) 
			$this->data['socnetauth2_instagram_client_secret'] = $this->request->post['socnetauth2_instagram_client_secret'];
		else
			$this->data['socnetauth2_instagram_client_secret'] = $this->config->get('socnetauth2_instagram_client_secret');
		
		if (isset($this->request->post['socnetauth2_instagram_customer_group_id'])) 
			$this->data['socnetauth2_instagram_customer_group_id'] = $this->request->post['socnetauth2_instagram_customer_group_id'];
		else
			$this->data['socnetauth2_instagram_customer_group_id'] = $this->config->get('socnetauth2_instagram_customer_group_id');
		...
		if (isset($this->request->post['socnetauth2_instagram_agent'])) 
		{
			$this->data['socnetauth2_instagram_agent'] = $this->request->post['socnetauth2_instagram_agent'];
		} 
		elseif( $this->config->has('socnetauth2_instagram_agent') )
		{ 
			$this->data['socnetauth2_instagram_agent'] = $this->config->get('socnetauth2_instagram_agent');
		}
		else
		{
			$this->data['socnetauth2_instagram_agent'] = 'extension';
		}
		
		if (isset($this->request->post['socnetauth2_instagram_status'])) 
		{
			$this->data['socnetauth2_instagram_status'] = $this->request->post['socnetauth2_instagram_status'];
		} 
		elseif( $this->config->has('socnetauth2_instagram_status') )
		{ 
			$this->data['socnetauth2_instagram_status'] = $this->config->get('socnetauth2_instagram_status');
		}
		else
		{
			$this->data['socnetauth2_instagram_status'] = 1;
		}
		
		if (isset($this->request->post['socnetauth2_instagram_debug'])) 
		{
			$this->data['socnetauth2_instagram_debug'] = $this->request->post['socnetauth2_instagram_debug'];
		} 
		elseif( $this->config->has('socnetauth2_instagram_debug') )
		{ 
			$this->data['socnetauth2_instagram_debug'] = $this->config->get('socnetauth2_instagram_debug');
		}
		else
		{
			$this->data['socnetauth2_instagram_debug'] = 0;
		}
		
		if (isset($this->request->post['socnetauth2_instagram_req'])) {
			$this->data['socnetauth2_instagram_req'] = $this->request->post['socnetauth2_instagram_req'];
		} elseif( $this->config->get('socnetauth2_instagram_req') ) { 
			$this->data['socnetauth2_instagram_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_instagram_req') );
		} else {
			$this->data['socnetauth2_instagram_req'] = array();
		}
		...
		} elseif( $this->config->get('socnetauth2_vkontakte_req') ) { 
			$this->data['socnetauth2_vkontakte_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_vkontakte_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_facebook_req') ) { 
			$this->data['socnetauth2_facebook_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_facebook_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_twitter_req') ) { 
			$this->data['socnetauth2_twitter_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_twitter_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_odnoklassniki_req') ) { 
			$this->data['socnetauth2_odnoklassniki_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_odnoklassniki_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_gmail_req') ) { 
			$this->data['socnetauth2_gmail_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_gmail_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_mailru_req') ) { 
			$this->data['socnetauth2_mailru_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_mailru_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_yandex_req') ) { 
			$this->data['socnetauth2_yandex_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_yandex_req') );
		} else {
		...
		} elseif( $this->config->get('socnetauth2_steam_req') ) { 
			$this->data['socnetauth2_steam_req'] = $this->custom_unserialize( $this->config->get('socnetauth2_steam_req') );
		} else {
		...
		{ 
			$this->data['socnetauth2_confirm_agree_status'] = $this->config->get('socnetauth2_confirm_agree_status');
		}
		...
		if (isset($this->request->post['socnetauth2_confirm_agree_required'])) {
			...
			$this->data['socnetauth2_confirm_agree_required'] = $this->config->get('socnetauth2_confirm_agree_required');
		}
		...
		{ 
			$this->data['socnetauth2_confirm_agree2_status'] = $this->config->get('socnetauth2_confirm_agree2_status');
		}
		...
		if (isset($this->request->post['socnetauth2_confirm_agree2_required'])) {
			...
			$this->data['socnetauth2_confirm_agree2_required'] = $this->config->get('socnetauth2_confirm_agree2_required');
		}
		...
		{ 
			$this->data['socnetauth2_confirm_agree3_status'] = $this->config->get('socnetauth2_confirm_agree3_status');
		}
		...
		if (isset($this->request->post['socnetauth2_confirm_agree3_required'])) {
			...
			$this->data['socnetauth2_confirm_agree3_required'] = $this->config->get('socnetauth2_confirm_agree3_required');
		}
		...
		{ 
			$this->data['socnetauth2_confirm_group_status'] = $this->config->get('socnetauth2_confirm_group_status');
		}
		...
		if (isset($this->request->post['socnetauth2_confirm_group_required'])) {
			...
			$this->data['socnetauth2_confirm_group_required'] = $this->config->get('socnetauth2_confirm_group_required');
		}
		...
		elseif( $this->config->has('socnetauth2_vkontakte_status') )
		{ 
		...
		elseif( $this->config->has('socnetauth2_facebook_status') )
		{ 
		...
		elseif( $this->config->has('socnetauth2_twitter_status') )
		{ 
		...
		elseif( $this->config->has('socnetauth2_gmail_status') )
		{ 
		...
		elseif( $this->config->has('socnetauth2_mailru_status') )
		{ 
		...
		{ 
			$this->data['socnetauth2_addpass'] = $this->config->get('socnetauth2_addpass');
		}	
		/* end 0902 */
		...
		{ 
			$this->data['socnetauth2_add_param'] = $this->config->get('socnetauth2_add_param');
		}
		/* end 2511 */
		...
		foreach($fields as $field)
		{
			...
			} elseif ($this->config->get('socnetauth2_confirm_'.$field.'_hideifhas')) { 
				$this->data['socnetauth2_confirm_'.$field.'_hideifhas'] = $this->config->get('socnetauth2_confirm_'.$field.'_hideifhas');
			} else {
		...
		} elseif ($this->config->has('socnetauth2_default_country')) { 
			$this->data['socnetauth2_default_country'] = $this->config->get('socnetauth2_default_country');
		} else {
		...
		if (isset($this->request->post['socnetauth2_confirm_newsletter'])) {
			...
			$this->data['socnetauth2_confirm_newsletter'] = $this->config->get('socnetauth2_confirm_newsletter');
		}
