...
$_['entry_minify_css_compress_status'] = 'Сжатие CSS';
$_['entry_minify_css_compress_status_help'] = 'Статус сжатия CSS';
...
$_['entry_minify_css_ex_combine_inline'] = 'Исключения кода inline style из обьединения CSS';
$_['entry_minify_css_ex_combine_inline_help'] = 'Параметры <br>разделяются <br>переводом "каретки" <br><span class="jc-help"># - выключает</span>';
...
$_['entry_minify_js_compress_status'] = 'Сжатие JS';
$_['entry_minify_js_compress_status_help'] = 'Статус сжатия JS';
...
$_['entry_webp'] = 'Оптимизация изображений по алгоритму webp';
...
$_['entry_jetcache_index_status'] = 'Start timer в index.php';
...
Вариантов комбинаций настроек сотни миллиардов.<br>
Как описать, подскажите? ;) Вот и я не знаю как физически можно описать сотни миллиардов вариантов настроек.<br>
Поэтому есть настройки по умолчанию в демо магазине. Повторите их - они работоспособны везде<br>
...
С уважением, разработчик Jet Cache.
';
...
$_['entry_minify_js_inline_compress_status'] = 'Сжатие inline JS';
$_['entry_minify_js_inline_compress_status_help'] = 'Статус сжатия inline JS';
$_['entry_minify_css_inline_compress_status'] = 'Сжатие inline CSS';
$_['entry_minify_css_inline_compress_status_help'] = 'Статус сжатия inline CSS';
...
$_['entry_minify_js_afterload_time_desktop'] = 'Автоматическое время загрузки <br>отложенных скриптов после DOM для desktop';
$_['entry_minify_js_afterload_time_mobile'] = 'Автоматическое время загрузки <br>отложенных скриптов после DOM для mobile';
