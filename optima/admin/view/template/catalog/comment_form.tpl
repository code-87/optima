...
<script src="<?php echo HTTPS_CATALOG;?>catalog/view/javascript/wysibb/jquery.wysibb.js" type="text/javascript"></script>
<script src="<?php echo HTTPS_CATALOG;?>catalog/view/javascript/wysibb/lang/<?php echo $config_language; ?>.js" type="text/javascript"></script>
<script src="<?php echo HTTPS_CATALOG;?>catalog/view/javascript/blog/blog.bbimage.js" type="text/javascript"></script>
<link href="<?php echo HTTPS_CATALOG;?>catalog/view/javascript/wysibb/theme/default/wbbtheme.css" type="text/css" rel="stylesheet" media="screen" />
...
karma_delete = function(id)	{
		...
		$.ajax({
			url: 'index.php?route=catalog/comment/karma_delete&action=<?php echo $mark_name; ?>&id=' + id + '&<?php echo $token_name; ?>=<?php echo $token; ?>',
			dataType: 'html',
			beforeSend: function()
			{
...
$('input[name=\'record\']').autocomplete({
	'source': function(request, response) {
         	...
         	?>
		$.ajax({
			url: 'index.php?route=catalog/comment/autocomplete&action=<?php echo $mark_name; ?>&<?php echo $token_name; ?>=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(irequest),
			dataType: 'json',
...
<script type="text/javascript">
	$('#bbtext').wysibb({
      ...
      buttons: 'bold,italic,underline,|,img,video,link,|,fontcolor,fontsize,|,code,quote,|,smilebox'
	});
   $('span.powered').hide();
</script>
