        ...
        <table class="mytable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <a target="_blank" href="<?php echo $comment['href'].$comment['commentlink']; ?>"><?php if (SC_VERSION > 15) { ?><i class="fa fa-link" aria-hidden="true"></i><?php } else { ?>#<?php } ?></a>
...
function filter() {
	url = 'index.php?route=catalog/comment&action=<?php echo $mark_name; ?>&<?php echo $token_name; ?>=<?php echo $token; ?>';
