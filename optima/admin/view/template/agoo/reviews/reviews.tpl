...
<?php if (SC_VERSION > 15) { ?>
  <a href="#tab-slider-<?php echo $list_num;?>"><?php echo $language->get('entry_tab_slider'); ?></a>
<?php } ?>
...
<table>
		...
		<?php if (!empty($categories)) { ?>
			<tr>
          	...
          	<tr>
              <td><?php echo $language->get('entry_blogs_join'); ?></td>
              <td>
              <div class="input-group">
              <select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][blogs_join]">
                  <?php if (isset($list['blogs_join']) && $list['blogs_join']) { ?>
		...
		<?php if (!empty($cat)) { ?>
			 <tr>
          	...
          	<tr>
              <td><?php echo $language->get('entry_categories_join'); ?></td>
              <td>
              <div class="input-group">
              <select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][categories_join]">
                  <?php if (isset($list['categories_join']) && $list['categories_join']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
     ...
     <td class="left">
      <div class="input-group">
      	<input type="text" class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][desc_pred]" value="<?php  if (isset( $list['desc_pred'])) echo $list['desc_pred']; ?>" size="3" />
			...
			<tr class="">
				<td><?php echo $language->get('entry_strip_tags_status'); ?></td>
				<td>
					<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][strip_tags_status]">
						<?php if (isset($list['strip_tags_status']) && $list['strip_tags_status']) { ?>
						<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
						<option value="0"><?php echo $text_disabled; ?></option>
						<?php } else { ?>
						<option value="1"><?php echo $text_enabled; ?></option>
...
<?php if (SC_VERSION > 15) { ?>
<div id="tab-slider-<?php echo $list_num;?>" class="tabs_in_widgets">
	<table>
			<tr>
              <td><?php echo $language->get('entry_widget_slider'); ?>
              </td>
              <td>
		            <div class="input-group">
		              	<select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][slider]" id="ascp_widgets_<?php echo $list_num; ?>_slider">
		                  <?php if (isset($list['slider']) && $list['slider']) { ?>
		                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
		                  <option value="0"><?php echo $text_disabled; ?></option>
		                  <?php } else { ?>
		                  <option value="1"><?php echo $text_enabled; ?></option>
					...
					<script>
						$( '#ascp_widgets_<?php echo $list_num; ?>_slider')
						.change(function () {
							var str = '';
							$( '#ascp_widgets_<?php echo $list_num; ?>_slider option:selected').each(function() {
							str = $(this).val();
							});
						});
					</script>
