...
<?php }  ?>
			...
			<tr>
				...
				<td>
					<div class="input-group">
					<select class="form-control" id="ascp_widgets_<?php echo $list_num; ?>_order_ad"  name="ascp_widgets[<?php echo $list_num; ?>][order_ad]">
         ...
         <tr>
              <td><?php echo $language->get('entry_widget_description_status'); ?></td>
              <td>
              	<div class="input-group">
              	<select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][description_status]">
