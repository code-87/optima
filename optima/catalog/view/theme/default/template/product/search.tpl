...
<a class="list-view active"><img src="img/row.svg" alt=""></a>
<a class="grid-view"><img src="img/column.svg" alt=""></a>
</div>
</div>
</div>

<div class="content content-search content-search-column">
<div class="wrapper">
