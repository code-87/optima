...
<form action="<?php echo $action; ?>" method="POST" id="socnetauth2_frame_confirmation"
...
<tr>
	<td width=80></td>
	<?php if( $is_noiframe ) { ?>
		<td><input type="button" onclick="socnetauthFrameConfirmation();" value="<?php echo $confirmform_button; ?>"></td>
	<?php } else { ?>
